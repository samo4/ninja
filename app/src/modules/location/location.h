...
/* Fallback defaults when location module Kconfig is not included. */
#if !defined(CONFIG_APP_LOCATION_NEIGHBOR_CELLS_MAX)
#define CONFIG_APP_LOCATION_NEIGHBOR_CELLS_MAX 10
#endif
#if !defined(CONFIG_APP_LOCATION_WIFI_APS_MAX)
#define CONFIG_APP_LOCATION_WIFI_APS_MAX 10
#endif
